    ...
    if request.method == 'POST':
        ...
        if len(password) < 6:
            ...
            return render(request, 'users/register.html',
                          context={'user_config': user_status, 'bio': bio, 'birthday': birthday,
                                   'specialities': specialities, 'user_firstname': first_name,
                                   'user_lastname': last_name, 'user_id': username, 'email': email,
                                   'user_gender': gender, 'address_line': address_line, 'region': region, 'city': city,
                                   'pincode': pincode})
